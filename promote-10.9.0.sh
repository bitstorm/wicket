...
git push origin rel/wicket-10.9.0

# promote the source distribution by moving it from the staging area to the release area

svn mv https://dist.apache.org/repos/dist/dev/wicket/10.9.0 https://dist.apache.org/repos/dist/release/wicket -m "Upload release to the mirrors"
